...
echo.
echo  ================================================================
echo   PediaCare AI  -  FULL DIAGNOSTIC TOOL
echo  ================================================================
echo.
echo PediaCare AI Diagnostic > "%RPT%"
...
call :SEC "4. FILES"
for %%F in ("server.py" "static\index.html" "modules\ai_providers.py" "START_PediaCare_AI.bat") do (
...
if %errorlevel%==0 (call :OK "  Server IS running on port %PORT%") else (call :WARN "  Server NOT running - start with START_PediaCare_AI.bat")
call :SEC "6. SECURITY"
...
if /i "%DC%"=="S" call "%BASEDIR%\START_PediaCare_AI.bat" & exit /b 0
if /i "%DC%"=="X" exit /b 0
goto :DM
:SEC
